                                ...
                                <tbody>
                                    ...
                                    @foreach ($getCMS as $key => $value)
                                        <tr>
                                            ...
                                            <td> <a href="{{ route('product.edit', $value->id) }}"class="btn btn-info "
                                            ...
                                            <td> <a href="{{ route('Plans.create', $value->product_id) }}"class="btn btn-primary "
                                                    type="button" id="dejangoshow"> Create
                                                </a>
                                            </td>
                                        </tr>
                                    @endforeach
